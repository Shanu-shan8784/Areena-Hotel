    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='w-full mt-4'>
            ...
            <input id='contact' type="number" placeholder='Phone' className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required/>
        </div>
        {/* Address */}
        <div className='w-full mt-4'>
        ...
        <div className='w-full mt-4 max-w-60 mr-auto'>
            ...
            <select id="city" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-2 outline-indigo-500 font-light' required>
                <option value=""></option>
                {cities.map((city)=>(
