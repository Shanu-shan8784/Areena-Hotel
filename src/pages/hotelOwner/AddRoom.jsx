...
function AddRoom() {
  ...
  return (
    <form>
      <Title align="left" font="outfit" title="Add Room" subTitle="Fill the details carefully and accurate room details, pricing, and amenities to enhance the user booking experience."/>
            ...
            <div key={index}>
                <input 
                  ...
                  onChange={() => setInputs({
                    ...inputs,
                    amenities: {
                      ...inputs.amenities, // 1. Spread the existing amenities object
                      [amenity]: !inputs.amenities[amenity] // 2. Toggle the specific amenity
                    }
                  })}
                />
