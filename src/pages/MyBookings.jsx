...
function MyBookings() {
  ...
  return (
    ...
    <Title title="My Bookings" subTitle='Easy manage your past, current and upcoming your hotel reservation in one place. Plan your trip seamlessly with just a few clicks.' align='left'/>
